...
const STATS_DATA: StatItem[] = [
  ...
  { label: '14+', desc: 'Projects Completed' },
...
I am passionate about exploring new technologies and building innovative solutions that create real-world impact.

I am a versatile full-stack developer with expertise in Python, JavaScript, TypeScript, React.js, Next.js, Node.js, and Linux. Over the past year, I have worked on diverse projects including:

- **Web & UI/UX Projects**: Tasty Kitchen (full stack with APIs), Jobby App (frontend), Tourism Website (HTML, Bootstrap), Food Munch (HTML, CSS), TechTrends India (React.js), Law Guide (team project with legal APIs), SubTrack (UI/UX for subscription tracking), and various Webflow design projects.
- **College Robotics Projects**: Smart Segregation Bin, and other hands-on automation projects.

I have also gained practical experience through my **internship**, where I contributed to real-world development workflows, cloud deployments, and full-stack application design.

In addition, I have volunteered in **4+ workshops** on AI, robotics, and digital design, contributing to community knowledge sharing and hands-on learning sessions.

My expertise spans **frontend development**, **backend development**, **database management**, **full-stack solutions**, **API integration**, **responsive design**, and **cloud hosting**. I focus on delivering scalable, user-friendly, and innovative digital products, combining clean code architecture, modern design principles, and a strong user-centered approach.

I am passionate about exploring emerging technologies and building solutions that create a tangible, positive impact in the real world.`,
  education: [
